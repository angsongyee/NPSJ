...
public final class Curve25519 {
	...
	/**
	 * Reduces a number modulo 2^255 - 19 where it is known that the number can be
	 * reduced with only 1 trial subtraction.
	 * 
	 * @param x
	 *            The number to reduce, and the result.
	 */
	 ...
	 *            The result.
	 * @param x
	 *            The value to be reduced. This array will be modified during the
	 *            reduction.
	 * @param size
	 *            The number of limbs in the high order half of x.
	 */
	 ...
	 * 
	 * @param select
	 *            Set to 1 to swap, 0 to leave as-is.
	 * @param x
	 *            The first value.
	 * @param y
	 *            The second value.
	 ...
	 * 
	 * @param result
	 *            The result. Must not overlap with x.
	 * @param x
	 *            The argument.
	 */
	 ...
	 * 
	 * @param result
	 *            Buffer to place the result of the evaluation into.
	 * @param offset
	 *            Offset into the result buffer.
	 * @param privateKey
	 *            The private key to use in the evaluation.
	 * @param publicKey
	 *            The public key to use in the evaluation, or null if the base point
	 *            of the curve should be used.
	 */
